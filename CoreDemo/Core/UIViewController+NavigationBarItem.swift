...
extension UIViewController {
    ...
    public func setRightButtonItem(titles: [String], actionBlock: ((UIButton) -> Void)?) {
        ...
        for (index, title) in titles.enumerated() {
            ...
            let titleSize = titleStr.boundingRect(with: CGSize(width: 200, height: 44), options: .usesFontLeading, attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 16.0)], context: nil).size
